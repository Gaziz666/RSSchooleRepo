...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => /* binding */ Chip\n/* harmony export */ });\n/* harmony import */ var _utils_create_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils/create.js */ \"./js/utils/create.js\");\n/* eslint-disable import/extensions */\n;\n\nclass Chip {\n  constructor(number, chipType) {\n    this.number = number;\n    this.chipType = chipType;\n\n    this.chip = (0,_utils_create_js__WEBPACK_IMPORTED_MODULE_0__.default)('div', `chip chip${this.chipType}`, String(number), null, ['key', number]);\n  }\n}\n\n\n//# sourceURL=webpack:///./js/chip.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => /* binding */ preHandleEvent\n/* harmony export */ });\n/* harmony import */ var _utils_create_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils/create.js */ \"./js/utils/create.js\");\n/* harmony import */ var _gem_puzzle_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./gem-puzzle.js */ \"./js/gem-puzzle.js\");\n/* harmony import */ var _storage_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./storage.js */ \"./js/storage.js\");\n/* harmony import */ var _bestBoard_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./bestBoard.js */ \"./js/bestBoard.js\");\n/* eslint-disable no-alert */\n/* eslint-disable prefer-destructuring */\n/* eslint-disable no-param-reassign */\n/* eslint-disable import/no-cycle */\n/* eslint-disable import/extensions */\n;\n\n// import gameType from './layouts/index.js';\n\n\n\nfunction preHandleEvent() {\n  if ((0,_storage_js__WEBPACK_IMPORTED_MODULE_2__.get)('isPause') === 'yes') return;\n  const gameTypeSelect = (0,_utils_create_js__WEBPACK_IMPORTED_MODULE_0__.default)('select', 'select', [\n    (0,_utils_create_js__WEBPACK_IMPORTED_MODULE_0__.default)('option', 'option', '3 * 3', null, ['value', '3']),\n    (0,_utils_create_js__WEBPACK_IMPORTED_MODULE_0__.default)('option', 'option', '4 * 4', null, ['value', '4'], ['selected', '']),\n    (0,_utils_create_js__WEBPACK_IMPORTED_MODULE_0__.default)('option', 'option', '5 * 5', null, ['value', '5']),\n    (0,_utils_create_js__WEBPACK_IMPORTED_MODULE_0__.default)('option', 'option', '6 * 6', null, ['value', '6']),\n    (0,_utils_create_js__WEBPACK_IMPORTED_MODULE_0__.default)('option', 'option', '7 * 7', null, ['value', '7']),\n    (0,_utils_create_js__WEBPACK_IMPORTED_MODULE_0__.default)('option', 'option', '8 * 8', null, ['value', '8']),\n  ], null, ['name', 'gameType']);\n  const listMenu = (0,_utils_create_js__WEBPACK_IMPORTED_MODULE_0__.default)('ul', 'menu',\n    [(0,_utils_create_js__WEBPACK_IMPORTED_MODULE_0__.default)('li', 'list', '<span class=\"pause-buttons\">Resume game</span>', null, ['game', 'resume']),\n      (0,_utils_create_js__WEBPACK_IMPORTED_MODULE_0__.default)('li', 'list', '<span class=\"pause-buttons\">Restart game</span>', null, ['game', 'restart']),\n      (0,_utils_create_js__WEBPACK_IMPORTED_MODULE_0__.default)('li', 'list', [\n        (0,_utils_create_js__WEBPACK_IMPORTED_MODULE_0__.default)('span', 'pause-buttons', 'New game'),\n        gameTypeSelect,\n      ], null, ['game', 'new']),\n      (0,_utils_create_js__WEBPACK_IMPORTED_MODULE_0__.default)('li', 'list', '<span class=\"pause-buttons\">Save game</span>', null, ['game', 'save']),\n      (0,_utils_create_js__WEBPACK_IMPORTED_MODULE_0__.default)('li', 'list', '<span class=\"pause-buttons\">Load game</span>', null, ['game', 'load']),\n      (0,_utils_create_js__WEBPACK_IMPORTED_MODULE_0__.default)('li', 'list', '<span class=\"pause-buttons\">Best score</span>', null, ['game', 'score'])]);\n  const icon = (0,_storage_js__WEBPACK_IMPORTED_MODULE_2__.get)('mute') === 'no'\n    ? (0,_utils_create_js__WEBPACK_IMPORTED_MODULE_0__.default)('i', 'material-icons', 'volume_up')\n    : (0,_utils_create_js__WEBPACK_IMPORTED_MODULE_0__.default)('i', 'material-icons', 'volume_off');\n  const popup = (0,_utils_create_js__WEBPACK_IMPORTED_MODULE_0__.default)('div', 'popup', [listMenu, icon]);\n  document.querySelector('.game-container').append(popup);\n  (0,_storage_js__WEBPACK_IMPORTED_MODULE_2__.set)('isPause', 'yes');\n  if (document.querySelector('.winner')) {\n    document.querySelector('.winner').remove();\n  }\n\n  const gameMenuEvent = (e) => {\n    const buttonType = e.target.closest('.list').dataset.game;\n    const gameChip = document.querySelectorAll('.chip');\n    const countMovie = document.querySelector('.counter');\n    const startOrder = (0,_storage_js__WEBPACK_IMPORTED_MODULE_2__.get)('chipOrder');\n    const sec = document.querySelector('.sec');\n    const min = document.querySelector('.min');\n    const saveOrder = [];\n    const saveChip = {};\n\n    if (buttonType === 'resume') { // click resume game\n      popup.remove();\n      (0,_storage_js__WEBPACK_IMPORTED_MODULE_2__.set)('isPause', 'no');\n    } else if (buttonType === 'restart') { // click restart game\n      gameChip.forEach((chip) => {\n        const order = startOrder.indexOf(chip.dataset.key);\n        // eslint-disable-next-line no-param-reassign\n        chip.style.order = order;\n      });\n      (0,_storage_js__WEBPACK_IMPORTED_MODULE_2__.set)('countMovie', 0);\n      (0,_storage_js__WEBPACK_IMPORTED_MODULE_2__.set)('isRestart', 'yes');\n      (0,_storage_js__WEBPACK_IMPORTED_MODULE_2__.set)('isPause', 'no');\n      countMovie.innerHTML = 0;\n      popup.remove();\n    } else if (buttonType === 'new') { // click new game\n      const newGameType = gameTypeSelect.value;\n      popup.remove();\n      (0,_storage_js__WEBPACK_IMPORTED_MODULE_2__.set)('isPause', 'no');\n      (0,_storage_js__WEBPACK_IMPORTED_MODULE_2__.set)('isRestart', 'yes');\n      (0,_storage_js__WEBPACK_IMPORTED_MODULE_2__.set)('countMovie', 0);\n      countMovie.innerHTML = 0;\n      gameChip.forEach((chip) => chip.remove());\n      new _gem_puzzle_js__WEBPACK_IMPORTED_MODULE_1__.default(newGameType).generateLayout(newGameType * newGameType);\n    } else if (buttonType === 'save') { // click save\n      let chipCount = 0;\n      gameChip.forEach((chip) => {\n        saveChip[chip.dataset.key] = [chip.style.order,\n          chip.style.background,\n          chip.style.backgroundPosition,\n          chip.style.backgroundSize,\n          chip.style.backgroundRepeat];\n        chipCount += 1;\n      });\n      saveOrder.push(saveChip);\n      saveOrder.push((0,_storage_js__WEBPACK_IMPORTED_MODULE_2__.get)('countMovie'));\n      saveOrder.push(min.innerHTML, sec.innerHTML);\n      saveOrder.push(Math.sqrt(chipCount));\n      (0,_storage_js__WEBPACK_IMPORTED_MODULE_2__.set)('save', saveOrder);\n      alert('game saved');\n    } else if (buttonType === 'load') {\n      if (!(0,_storage_js__WEBPACK_IMPORTED_MODULE_2__.get)('save')) {\n        alert('no save game');\n        return;\n      }\n      gameChip.forEach((chip) => chip.remove());\n      const loadGameType = Number((0,_storage_js__WEBPACK_IMPORTED_MODULE_2__.get)('save')[4]);\n      new _gem_puzzle_js__WEBPACK_IMPORTED_MODULE_1__.default(loadGameType).generateLayout(loadGameType * loadGameType);\n      const newGameChip = document.querySelectorAll('.chip');\n      newGameChip.forEach((chip) => {\n        // eslint-disable-next-line no-param-reassign\n        chip.style.order = (0,_storage_js__WEBPACK_IMPORTED_MODULE_2__.get)('save')[0][chip.dataset.key][0];\n        chip.style.background = (0,_storage_js__WEBPACK_IMPORTED_MODULE_2__.get)('save')[0][chip.dataset.key][1];\n      });\n      (0,_storage_js__WEBPACK_IMPORTED_MODULE_2__.set)('countMovie', (0,_storage_js__WEBPACK_IMPORTED_MODULE_2__.get)('save')[1]);\n      (0,_storage_js__WEBPACK_IMPORTED_MODULE_2__.set)('isPause', 'no');\n      countMovie.innerHTML = (0,_storage_js__WEBPACK_IMPORTED_MODULE_2__.get)('countMovie');\n      (0,_storage_js__WEBPACK_IMPORTED_MODULE_2__.set)('loadSaveGame', 'yes');\n      popup.remove();\n    } else if (buttonType === 'score') {\n      (0,_bestBoard_js__WEBPACK_IMPORTED_MODULE_3__.default)();\n    }\n  };\n\n  const audioEvent = () => {\n    if ((0,_storage_js__WEBPACK_IMPORTED_MODULE_2__.get)('mute') === 'no') {\n      icon.innerHTML = 'volume_off';\n      (0,_storage_js__WEBPACK_IMPORTED_MODULE_2__.set)('mute', 'yes');\n    } else {\n      icon.innerHTML = 'volume_up';\n      (0,_storage_js__WEBPACK_IMPORTED_MODULE_2__.set)('mute', 'no');\n    }\n  };\n\n  const buttons = document.querySelectorAll('.pause-buttons');\n  buttons.forEach((button) => button.addEventListener('click', gameMenuEvent));\n  icon.addEventListener('click', audioEvent);\n}\n\n\n//# sourceURL=webpack:///./js/handleEventPause.js?");
