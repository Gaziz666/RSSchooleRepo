...
const paused = create('button', 'pause nonvisible', 'Paused');
...
export default class GemPuzzle {
  ...
  init() {
    this.header = create('header', 'game-header', [timer, counter, pause, paused]);
    ...
    pause.addEventListener('click', () => handleEventPause(pause, paused));
  }
}
