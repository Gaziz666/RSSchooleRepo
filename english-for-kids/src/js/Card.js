...
import getPlayIcon from './icons/getPlayIcon';
import getRepeatIcon from './icons/getRepeatIcon';
      ...
      const frontCard = create('div', {
        ...
        child: [
          create('div', {
            ...
            parent: null,
            child: null,
            dataAttr: [['style', `background-image: url("${card.image}"`]],
          }),
          name,
          rotateBtn,
          audio,
