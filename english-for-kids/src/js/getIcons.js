const getCloseIcon = ({
  attribute, className, width, height,
}) => {
...
const getBurgerMenuIcon = ({
  ...
  const div = document.createElement(attribute);
  div.innerHTML = `
  <svg width="${width}" height="${height}" viewBox="0 0 512 512"><g fill="#ff485a">
  ...
  <path d="M479.18 288.821h-52.513c-18.13 0-32.821-14.69-32.821-32.821s14.69-32.821 32.821-32.821h52.513c18.13 0 32.82 14.69 32.82 32.821s-14.69 32.821-32.82 32.821z" fill="#ffbbc0"/>
  <path d="M479.18 485.744H32.821C14.69 485.744 0 471.053 0 452.923c0-18.13 14.69-32.821 32.821-32.821H479.18c18.13 0 32.82 14.69 32.82 32.821 0 18.13-14.69 32.821-32.82 32.821z" fill="#ff485a"/>
  </svg>    
  `;
  div.classList.add(className);
  return div;
...
export {
  getCloseIcon, getSchoolIcon, getRepeatIcon, getPlayIcon, getBurgerMenuIcon,
};
